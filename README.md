# Advanced Computer Networks Lab (PCS223)
...
### 🔹 Assignment 1 & 2 – Packet Analysis

* Captured and analyzed network packets using Wireshark
* Studied protocols: **ICMP, TCP, UDP, DNS, HTTP, ARP**
* Observed packet structure, IP/MAC addressing, and protocol behavior

---

### 🔹 Assignment 3 – Network Topologies & Analysis
...
### 🔹 Assignment 4 – DHCP Configuration

* Configured DHCP server on router
* Implemented:
...
### 🔹 Assignment 7 – OSPF Routing

* Configured **OSPF (Link State Routing Protocol)**
* Established adjacency between routers
...
* All assignments include configurations, outputs, and verification
* Network topologies are tested and functional
* Repository is organized for clarity and evaluation purposes
